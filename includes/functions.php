 ...
 */
function aplicarDescuento(array $producto, float $descuento = 15): float {
    // Verifico si la temporada del producto es invierno
    //Uso el srtpos ya que me permite buscar una cadena dentro de otra cadena dentro de temporada
    if (isset($producto['temporada']) && strpos(strtolower($producto['temporada']), 'invierno') !== false) {
