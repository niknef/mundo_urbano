<section class="alumno d-flex align-items-center justify-content-center">
    <div class="row featurette align-items-center text-center">
        ...
        <div class="d-flex justify-content-center gap-3">
            ...
            <a href="https://www.linkedin.com/in/nicolasfirpo/" target="_blank" class="badge custom-badge bg-info">
            <i class="bi bi-linkedin"></i> LinkedIn
            </a>
            <a href="https://github.com/niknef" target="_blank" class="badge custom-badge bg-dark">
            <i class="bi bi-github"></i> GitHub
            </a>
        </div>
        </div>
        <div class="col-md-5 order-md-last order-first">
        <img src="./img/perfil-nicolas-firpo.png" alt="Nicolás Firpo" class="featurette-image img-fluid mx-auto rounded-circle">
        </div>
    </div>
</section>
